# Based on johejo solution:
# https://github.com/johejo/inputimeout/tree/master/inputimeout
...
if __name__ == '__main__':
    ...
    try:
        timeout = 10
        prompt = f"У вас есть {timeout} секунд, чтобы ввести текст: \n"
        s = inputimeout(prompt, timeout)
        print(f"Вы ввели '{s}'.")
