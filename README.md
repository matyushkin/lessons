# lessons
Репозиторий содержит блокноты Jupyter, представляющих собой интерактивные версии публикаций для образовательных ресурсов. Если нужно что-то поправить, добавляйте `issue` здесь, пишите в телеграм-чат ✈️ ([@matyushkin_chat](https://t.me/matyushkin_chat)) или на почту 📬 [leva.matyushkin@gmail.com](mailto:leva.matyushkin@gmail.com). Выход публикаций аннонсируется в телеграм-канале [@leomatyushkin](https://t.me/leomatyushkin) и [паблике vk](https://vk.com/python_ds). Если вам нравятся мои переводы и тексты, меня можно [поддержать](https://matyushkin.github.io/donate/) 🙏. 

## Перечень публикаций
Большинство публикаций подготовлены для [Библиотеки программиста](https://proglib.io/), более ранние — для [Хабра](https://habr.com/ru/users/LeoMat/). В репозитории представлены лишь публикации на темы, связанные с различными аспектами программирования. Научные статьи по материаловедению смотрите в ([профиле на ResearchGate](https://www.researchgate.net/profile/Lev_Matyushkin)).

Статьи расположены в рубриках преимущественно в обратном хронологическом порядке.
