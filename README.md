# lessons
Репозиторий состоит из Jupyter-блокнотов, представляющих собой интерактивные версии публикаций для различных образовательных ресурсов. Если нужно что-то поправить, добавляйте `issue`, пишите в телеграм-чат ✈️ ([@matyushkin_chat](https://t.me/matyushkin_chat)) или на почту 📬 [leva.matyushkin@gmail.com](mailto:leva.matyushkin@gmail.com). Выход новых публикаций аннонсируется в телеграме [@leomatyushkin](https://t.me/leomatyushkin) и [паблике vk](https://vk.com/python_ds). Если вам нравятся мои переводы и тексты, меня можно [поддержать](https://matyushkin.github.io/donate/) 🙏. 

## Перечень публикаций
Большинство публикаций подготовлены для [Библиотеки программиста](https://proglib.io/), более ранние — для [Хабра](https://habr.com/ru/users/LeoMat/). Это и оригинальные статьи и пособия, и переводы англоязычных статей. Ниже представлены публикации на темы, связанные с различными аспектами программирования. Научные публикации можно посмотреть в ([профиле на ResearchGate](https://www.researchgate.net/profile/Lev_Matyushkin)).
