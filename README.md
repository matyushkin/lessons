# lessons
Блокноты Jupyter, подготовленные мной для различных образовательных ресурсов, а также интерактивные версии публикаций. Если нужно что-то исправить, добавляйте `issue`, пишите в телеграм-чат ✈️ ([@matyushkin_chat](https://t.me/matyushkin_chat)). или на почту 📬 [leva.matyushkin@gmail.com](mailto:leva.matyushkin@gmail.com). Следить за выходом новых публикаций и блокнотов удобно в телеграме [@leomatyushkin](https://t.me/leomatyushkin) или [паблике vk](https://vk.com/python_ds). Если вам нравится то, что я делаю, меня можно [поддержать](https://matyushkin.github.io/donate/) 🙏. 

## Перечень публикаций
Большинство публикаций подготовлены для [Библиотеки программиста](https://proglib.io/), более ранние – для [Хабра](https://habr.com/ru/users/LeoMat/). Публикации представляют собой как оригинальные статьи и пособия, так и переводы англоязычных статей.

Ниже представлены публикации на темы, связанные с различными аспектами программирования. Научные публикации можно посмотреть в ([профиле на ResearchGate](https://www.researchgate.net/profile/Lev_Matyushkin)).
...
### Другие
- [Stepk-курс «Статьи для IT: как объяснять и распространять значимые идеи»](https://stepik.org/course/101672/)
- [Stepk-курс «Наноматериалы»](https://stepik.org/course/52514) 
