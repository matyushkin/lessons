...
👓 Если вам интересны подобные публикации, загляните в мой телеграм-канал [@leomatyushkin](https://tggg.me/leomatyushkin).
...
- 🤼 [Генеративно-состязательная нейросеть: ваша первая GAN-модель на PyTorch]() ([Jupyter](https://proglib.io/p/generativno-sostyazatelnaya-neyroset-vasha-pervaya-gan-model-na-pytorch-2020-08-11)) ([ист.](https://realpython.com/generative-adversarial-networks/))
