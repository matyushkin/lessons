# lessons
Блокноты Jupyter для различных образовательных ресурсов и интерактивные версии публикаций. Открыт к предложениям: нужно что-то исправить – добавляйте `issue` или комментарий на сайте публикации. Пишите в телеграм ✈️ [@bythi](https://t.me/bythi) или на почту 📬 [leva.matyushkin@gmail.com](mailto:leva.matyushkin@gmail.com). Если вам нравится то, что я делаю, меня можно [поддержать](https://matyushkin.github.io/donate/) 🙏.

👓 Если вам интересны подобные публикации, загляните в мой телеграм-канал [@leomatyushkin](https://t.me/leomatyushkin) или [паблик vk](https://vk.com/python_ds).

## Перечень публикаций
Большинство публикаций подготовлены для [Библиотеки программиста](https://proglib.io/) (в этом случае названия часто скорректированы редактором), более ранние – для [Хабра](https://habr.com/ru/users/LeoMat/). Публикации представляют собой как оригинальные статьи и пособия, так и переводы англоязычных статей.

Ниже представлены публикации на тему программирования. Также я занимаюсь научными исследованиями ([профиль на ResearchGate](https://www.researchgate.net/profile/Lev_Matyushkin)) и учебной деятельностью ([курс Наноматериалы на stepik.org](https://stepik.org/course/52514/syllabus)). Сейчас основной исследовательский проект — [исследование первых воспоминаний](https://github.com/matyushkin/reminiscence).
...
- [Линейное программирование. Практика решения задач оптимизации на Python](https://proglib.io/p/lineynoe-programmirovanie-praktika-resheniya-zadach-optimizacii-na-python-2020-11-26) ([ист.](https://realpython.com/linear-programming-python/)) ([Jupyter](https://github.com/matyushkin/lessons/blob/master/algorithms/linear_programiing_optimization.ipynb),  [Colab](https://colab.research.google.com/github.com/matyushkin/lessons/blob/master/algorithms/linear_programiing_optimization.ipynb))
