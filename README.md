...
### Python
- [Динамическое выполнение выражений в Python: eval()](https://proglib.io/p/dinamicheskoe-vypolnenie-vyrazheniy-v-python-funkciya-eval-2020-05-14) ([блокнот Jupyter](eval_func/eval_func.ipynb), [Colab](https://colab.research.google.com/github/matyushkin/lessons/blob/master/eval_func/eval_func.ipynb)) (перевод [Python eval(): Evaluate Expressions Dynamically](https://realpython.com/python-eval-function/))
- [Всё, что нужно знать о декораторах Python](https://proglib.io/p/vse-chto-nuzhno-znat-o-dekoratorah-python-2020-05-09) ([блокнот Jupyter](decorators/decorators.ipynb), [Colab](https://colab.research.google.com/github/matyushkin/lessons/blob/master/decorators/decorators.ipynb))
