# lessons
Блокноты Jupyter для различных образовательных ресурсов и интерактивные версии публикаций. Открыт к предложениям: нужно что-то исправить – добавляйте issue или комментарий на сайте публикации. Пишите в телеграм ✈️ [@bythi](https://tggg.me/bythi) или на почту 📬 [leva.matyushkin@gmail.com](mailto:leva.matyushkin@gmail.com). 
...
### Python
- [Динамическое выполнение выражений в Python: eval()](https://proglib.io/p/dinamicheskoe-vypolnenie-vyrazheniy-v-python-funkciya-eval-2020-05-14) ([Jupyter](eval_func/eval_func.ipynb), [Colab](https://colab.research.google.com/github/matyushkin/lessons/blob/master/eval_func/eval_func.ipynb)) – перевод статьи Леоданиса Позо Рамоса [Python eval(): Evaluate Expressions Dynamically](https://realpython.com/python-eval-function/)
- [Всё, что нужно знать о декораторах Python](https://proglib.io/p/vse-chto-nuzhno-znat-o-dekoratorah-python-2020-05-09) ([Jupyter](decorators/decorators.ipynb), [Colab](https://colab.research.google.com/github/matyushkin/lessons/blob/master/decorators/decorators.ipynb)) – перевод руководства Гейра Арне Хьелле [Primer on Python Decorators](https://realpython.com/primer-on-python-decorators/)
- **[Как подружить Python и базы данных SQL. Подробное руководство](https://proglib.io/p/kak-podruzhit-python-i-bazy-dannyh-sql-podrobnoe-rukovodstvo-2020-02-27)** – перевод статьи Усмана Малика [Introduction to Python SQL Libraries](https://realpython.com/python-sql-libraries/)
- [Python и динамическое программирование на примере задачи о рюкзаке](https://proglib.io/p/python-i-dinamicheskoe-programmirovanie-na-primere-zadachi-o-ryukzake-2020-02-04) – перевод статьи Хенни де Хардер [Choosing Fast with Dynamic Programming](https://towardsdatascience.com/choosing-fast-with-dynamic-programming-b6916da543f4)
- [Как опубликовать свою Python библиотеку на PyPI](https://proglib.io/p/kak-opublikovat-svoyu-python-biblioteku-na-pypi-2020-01-28) – перевод статьи Алекса Михайловича [Make your own Python package](https://towardsdatascience.com/make-your-own-python-package-6d08a400fc2d)
- [Веб-скрапинг по расписанию с Django и Heroku](https://proglib.io/p/veb-skraping-po-raspisaniyu-s-heroku-i-django-2020-01-17)  – перевод инструкции Криса из Торонто [Scheduled Web Scraping with Django and Heroku](https://towardsdatascience.com/scheduled-web-scraping-with-django-and-heroku-e832e1363c7a?source=rss----7f60cf5620c9---4)
- [Иллюстрированное руководство по изменению формы массивов NumPy](https://proglib.io/p/illyustrirovannoe-rukovodstvo-po-izmeneniyu-formy-mnogomernyh-massivov-numpy-2020-01-12) – перевод туториала Hause [Reshaping numpy arrays in Python — a step-by-step pictorial tutorial](https://towardsdatascience.com/reshaping-numpy-arrays-in-python-a-step-by-step-pictorial-tutorial-aed5f471cf0b)- **[Итерируем правильно: 20 приемов использования в Python модуля itertools](https://proglib.io/p/iteriruemsya-pravilno-20-priemov-ispolzovaniya-v-python-modulya-itertools-2020-01-03)**
...
- [Пишем программу для автоматического распознавания объектов с веб-камер](https://proglib.io/p/pishem-programmu-dlya-avtomaticheskogo-raspoznavaniya-obektov-s-veb-kamer-2019-10-05) – перевод руководства Адриана Роузброка [Live video streaming over network with OpenCV and ImageZMQ](https://www.pyimagesearch.com/2019/04/15/live-video-streaming-over-network-with-opencv-and-imagezmq/)
- [Спасательный круг для собеседования на Python-разработчика](https://proglib.io/p/py-interview)
- [Требования к Python-разработчику на мировом рынке 2019 года](https://proglib.io/p/python-dev-2019) – на основе [What do companies expect from Python devs in 2019?](https://hackernoon.com/what-do-companies-expect-from-python-devs-in-2019-f8b585a1ddf)
- [Быстрый путеводитель по Python: cписки за 7 минут](https://proglib.io/p/python-lists) – перевод статьи Палаколлу Шри Маниканта [A quick yet complete tour of lists in Python3 in just seven minutes](https://www.freecodecamp.org/news/a-quick-yet-complete-tour-of-lists-in-python3-in-just-seven-minutes-437e615110d0/)
- [Pythran: как заставить работать код Python со скоростью С++](https://proglib.io/p/pythran) – перевод статьи Оливье Бордериса [Pythran: Python at C++ speed!](https://medium.com/@olivier.borderies/pythran-python-at-c-speed-518f26af60e8)
